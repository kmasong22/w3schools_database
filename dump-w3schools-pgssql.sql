...
CREATE TABLE public.categories (
	...
	categoryname varchar(255) NULL DEFAULT NULL::character varying,
...
CREATE TABLE public.customers (
	...
	customername varchar(255) NULL DEFAULT NULL::character varying,
	contactname varchar(255) NULL DEFAULT NULL::character varying,
	address varchar(255) NULL DEFAULT NULL::character varying,
	city varchar(255) NULL DEFAULT NULL::character varying,
	postalcode varchar(255) NULL DEFAULT NULL::character varying,
...
CREATE TABLE public.employees (
	...
	birthdate date NULL,
	photo varchar(255) NULL DEFAULT NULL::character varying,
	notes text NULL,
...
CREATE TABLE public.products (
	...
	productname varchar(255) NULL DEFAULT NULL::character varying,
	supplierid int4 NULL,
	categoryid int4 NULL,
	unit varchar(255) NULL DEFAULT NULL::character varying,
	price float8 NULL
);
...
CREATE TABLE public.shippers (
	...
	shippername varchar(255) NULL DEFAULT NULL::character varying,
...
CREATE TABLE public.suppliers (
	...
	suppliername varchar(255) NULL DEFAULT NULL::character varying,
	contactname varchar(255) NULL DEFAULT NULL::character varying,
	address varchar(255) NULL DEFAULT NULL::character varying,
	city varchar(255) NULL DEFAULT NULL::character varying,
	postalcode varchar(255) NULL DEFAULT NULL::character varying,
...
INSERT INTO public.products (productid,productname,supplierid,categoryid,unit,price) VALUES
